...
{
    /// <summary>
    /// Controlador para gestionar módulos de formularios.
    /// </summary>
    [ApiController]
    ...
    public class FormModuleController : ControllerBase
    {
        ...
        /// <summary>
        /// Obtiene todos los módulos de formularios.
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// Obtiene un módulo de formulario por ID.
        /// </summary>
        [HttpGet("{id}")]
        ...
        public async Task<IActionResult> Create([FromBody] FormModule entity)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Update(int id, [FromBody] FormModule entity)
        {
            try
            {
                entity.Id = id;
        ...
        /// <summary>
        /// Elimina un módulo de formulario por ID.
        /// </summary>
        [HttpDelete("{id}")]
        [Authorize(Roles = "Admin")]
